...
- Collections: `staff_users`, `orders`, `stripe_events`, `email_outbox`, `government_fees`, and `attendance_records`.
...
- Analytics outbox, admin UI support, and more restrictive public tracking projection.
