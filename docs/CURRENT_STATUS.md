...
- Payment-confirmation email branches on rush: shared "Your application will be reviewed." line, standard workflow paragraph normally, Rush-channel paragraph when rush was paid. All emails use the email-sized logo via direct `usvc-logo-email.png` URL (256px, ~46KB — sized for Gmail's image proxy).
